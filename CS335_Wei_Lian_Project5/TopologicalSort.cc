/******************************************************************************
  ...
  Description    : main interface of TopologicalSort program
  Purpose        : the program create a graph, and use the topological sorting algorithm if the graph is not a cycle.
  Modifications  : 
